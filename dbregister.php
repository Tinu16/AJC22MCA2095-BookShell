            ...
            <div class="card-body p-0">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                ...
                                <h1 class="h4 text-gray-900 mb-4">Become a delivery agent!</h1>
                            </div>
                            <form class="user" method="POST" action="dbregistercode.php" onsubmit="return validateForm()">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="hidden" name="usertype" value="delivery_boy">
                                </div>
                    ...
                    <div class="col-lg-5 d-none d-lg-flex align-items-center justify-content-center">
                        <img src="../img/delivery_boy.png" class="img-fluid img-medium" alt="Delivery Boy Image">
                    </div>
                </div>
            </div>
        </div>
