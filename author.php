...
<div class="container">
    ...
    <div class="col-xl-5 col-lg-12 col-md-10">
                        ...
                        <div class="p-5">
                            <div class="text-center">
                               ...
                               ?>
                                ...
                                <h1 class="h4 text-gray-900 mb-4">Add Author</h1>
        ...
        <div class="form-group">
                  <input type="text" name="authorname" class="form-control form-control-user"
        ...
        <hr>
            <button type="sumit" name="add_more" class="btn btn-primary" data-dismiss="modal">Add More</button>
        <hr>
</div>
      </form>
